...
// Note! The next statement will stop the sketc Farnell Farnell Farnellh from running until the serial monitor is started
...
//hstrings = Display.file_Open("TEST2~1.txf", 'r') ;                            // Open handle to access uSD strings, uncomment if required
  hndl = Display.file_LoadImageControl("TEST2~1.dat", "TEST2~1.gci", 1);
